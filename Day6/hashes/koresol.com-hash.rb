...
service = {"service1" => "Eccomerce Website Development", "service2" => "iOS Application Development", "service3" => "Android Application Development", "service4" => "iPhone Application Development"} 
puts service
print  "Get Particular Value Using Key :"
puts service["service2"]
